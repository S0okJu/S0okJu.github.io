...
![](/assets/img/post/project-nct/architecture/nct_old_architecture.png)

## 웹서버
웹서버는 front에만 연결할 수 있도록 작성하고, front ↔ backend와 통신할 수 있도록 개선하고자 한다.

![](/assets/img/post/project-nct/figures/normal_web_arch.png)
...
![](/assets/img/post/project-nct/architecture/nct_new_arch_v0.1.png)
